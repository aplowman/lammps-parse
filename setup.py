"""Pip installation script for `lammps-parse`."""
...
def get_version():
    ...
    ver_file = '{}/_version.py'.format('lammps_parse')
...
setup(
    name='lammps-parse',
    version=get_version(),
    description=('Input file writers and output file parsers for Lammps.'),
    ...
    project_urls={
        'Github': 'https://github.com/aplowman/lammps-parse',
    },
    classifiers=[
